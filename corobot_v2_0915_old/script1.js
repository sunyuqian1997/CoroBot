...
/*var oC = document.getElementsByTagName("canvas")
...
function createWorld() {
  ...
  //scene.background = new THREE.Color("rgba(182,11,23,0.1)");
/*	  scene.background.fillStyle ='blue'*/
/*	var light = new THREE.HemisphereLight( 0xffffff, 0xeeeeee, 0.75 );
  ...
  scene.add( light );*/
    ...
    obj.addColorStop(0,"rgba(0,233,2333,0.1)")
    scene.fillStyle = obj;
    scene.fillRect(0,0,150,100);*/

  //---
  camera = new THREE.PerspectiveCamera(45, _width/_height, 1, 1000);
